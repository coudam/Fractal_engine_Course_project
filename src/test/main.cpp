...
void init_scene(engine& e) {
	safe_vec_ref<Shader> light_obj_shader = e.set_shader("../../src/shaders/src/shader.vert", "../../src/shaders/src/shader.frag");
    safe_vec_ref<Shader> obj_shader = e.set_shader("../../src/shaders/src/light_shader.vert", "../../src/shaders/src/light_shader.frag");
	...
	safe_vec_ref<Model> sphere = e.set_model(Model(obj_shader, GL_TRIANGLE_STRIP, Shapes::sphere, glm::vec3(0.f, 0.f, 0.f), 3, 40));
