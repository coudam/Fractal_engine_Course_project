...
Model::Model(safe_vec_ptr<Shader> &s, GLenum mode, const float *vert, const float *norm, const float *uv, int num):
...
Model::Model(safe_vec_ptr<Shader> &s, GLenum mode, const char *path):
